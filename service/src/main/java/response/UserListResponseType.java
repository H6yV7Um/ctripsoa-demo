...
public class UserListResponseType implements SpecificRecord, HasResponseStatus, Serializable {
    ...
    public void setList(final List<UserDto> list) {
        this.list = list;
    }
    ...
    public void put(int fieldPos, Object fieldValue) {
        switch (fieldPos) {
            case 0: this.list = (List<UserDto>)fieldValue; break;
    ...
    public boolean equals(Object obj) {
        ...
        final UserListResponseType other = (UserListResponseType)obj;
        return 
